  ...
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-green-700">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute top-2/3 left-0 h-[0.58em] w-full fill-blue-400/80"
          ...
          <span className="relative">in Pakistan</span>
        </span>{' '}
      ...
      <div className="mt-24 lg:mt-40">
        <p className="font-display text-3xl font-medium tracking-tight text-slate-700 sm:text-4xl">
          The Flood Affectees and Devestation
        </p>
        <ul
          role="list"
          className="mt-4 flex flex-col items-center justify-center sm:gap-y-10 md:flex-row md:gap-x-10 xl:flex-row xl:gap-x-12 xl:gap-y-0"
        >
          {[
            { title: 'People Killed', count: '1.6K' },
            { title: 'People Injured', count: '12.7K+' },
